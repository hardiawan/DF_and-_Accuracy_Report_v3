...
class Ui_MainWindow(object):
    ...
    def setupDailyReportTab(self):
        ...
        labels = [
            ...
            ("label_6", "Choose Field / Block", 20, 135),
            # ("label_7", "Spray Date            (dd/mm/yyyy)", 20, 160),
            ...
            # ("label_dose", "Dose (ml)", 700, 350),
            # ("label_sph", "Number of SPH", 700, 375),
    ...
    def setupDailyReportTabInputs(self):
        ...
        # self.DATE_1.setGeometry(QtCore.QRect(540, 160, 140, 20))
        # font = QtGui.QFont()
        # font.setPointSize(10)
        # self.DATE_1.setFont(font)
        # self.DATE_1.setDateTime(QtCore.QDateTime(QtCore.QDate(2024, 12, 1), QtCore.QTime(0, 0, 0)))
        # self.DATE_1.setDate(QtCore.QDate(2024, 12, 1))
        # self.DATE_1.setObjectName("DATE_1")

        ## SKEMA BIASA SAJA
        # self.comboBox_2 = self.createComboBox(self.tab, ["SIME DERBY PLANTATION", "Others"], 540, 85)
        # self.comboBox_1 = self.createComboBox(self.tab, ["Others", "Chaah", "North Labis", "Sungai Simpang Kiri", "Yong Peng"], 540, 110)
        # self.comboBox_6 = self.createComboBox(self.tab, ["Others", "P22A", "P22B", "P22C", "P22D", "P22E", "P23A", "P23B", "P23C", "P23D", "P23E"], 540, 135)
        ...
        self.lineEdit_combo6.textChanged.connect(self.update_lineEdit_10u)
    ...
    def updateComboBox1(self):
        ...
        if os.path.exists(self.history_file_path):
            ...
            # self.lineEdit_10e = QtWidgets.QLineEdit(self.tab)
            # self.lineEdit_10e.setGeometry(QtCore.QRect(850, 170, 140, 20))
            # self.lineEdit_10e.setObjectName("lineEdit_10e")
            # self.lineEdit_10e.setText(self.form_input_history["lineEdit_10e"])
            ...
            def update_combobox_item(value):
                self.comboBox_10t.setItemText(0, f"{value}th rotation")
            ...
            self.comboBox_10t.addItems([f"{self.spinBox_10t.value()}th rotation", "New", "Spot Reservice"])
            self.spinBox_10t.valueChanged.connect(update_combobox_item)
            ...
            self.lineEdit_10u.textChanged.connect(self.prevent_update)
            # self.lineEdit_10u.setText(self.form_input_history["lineEdit_10u"])
            ...
            # self.lineEdit_10u1.textChanged.connect(self.prevent_update)
            # self.lineEdit_10u.setText(self.form_input_history["lineEdit_10u"])
            ...
            self.textEdit_10z5.setText("To complete the spraying using method 'palm by palm' to the   , plot number ")
            self.lineEdit_combo6.textChanged.connect(lambda text: self.textEdit_10z5.setText(f"To complete the spraying using method 'palm by palm' to the   , plot number {text}"))

            # self.lineEdit_dose = QtWidgets.QLineEdit(self.tab)
            # self.lineEdit_dose.setGeometry(QtCore.QRect(850, 350, 140, 20))
            # self.lineEdit_dose.setObjectName("lineEdit_dose")
            # self.lineEdit_dose.setText(self.form_input_history["lineEdit_dose"])

            # self.lineEdit_sph = QtWidgets.QLineEdit(self.tab)
            # self.lineEdit_sph.setGeometry(QtCore.QRect(850, 380, 140, 20))
            # self.lineEdit_sph.setObjectName("lineEdit_sph")
            # self.lineEdit_sph.setText(self.form_input_history["lineEdit_sph"])
            ...
            self.lineEdit_10h = QtWidgets.QLineEdit(self.tab)
            self.lineEdit_10h.setGeometry(QtCore.QRect(850, 295, 140, 20))
            self.lineEdit_10h.setObjectName("lineEdit_10h")
            ...
            # self.lineEdit_10z = QtWidgets.QLineEdit(self.tab)
            # self.lineEdit_10z.setGeometry(QtCore.QRect(1180, 395, 140, 20))
            # self.lineEdit_10z.setObjectName("lineEdit_10z")
    ...
    def updateComboBox2(self):
        ...
        if selection == "SMART Tbk.":
            items = ["Others","Pelakar","Tanah Laut", "Sungai Kupang", "Batu Ampar", "Kajui", "Jalemo", "Manuhing", "Naga Sakti", "Naga Mas", "Kijang"]
    ...
    def update_lineEdit_10u(self, text):
        """Update lineEdit_10u when lineEdit_combo6 is edited."""
        self.lineEdit_10u.blockSignals(True)  # Prevent signal loop
        self.lineEdit_10u.setText(text.upper())
        self.lineEdit_combo6.setText(text.upper())
        self.lineEdit_10u.blockSignals(False)  # Re-enable signals

    def prevent_update(self, text):
        """Do nothing when lineEdit_10u is edited."""
        pass
    ...
    def setupMergeReportTabInputs(self):
        ...
        self.comboBox_4 = self.createComboBox(self.MergePDF, ["CHAAH", "NORTH LABIS", "SUNGAI SIMPANG KIRI", "YONG PENG", "KEMPAS KLEMBANG", "KAJUI", "JALEMO", "MANUHING", "NAGA SAKTI", "NAGA MAS", "KIJANG","Pelakar","Tanah Laut", "Sungai Kupang", "Batu Ampar", "OTHERS"], 600, 140)
        ...
        # self.DATE_2 = self.createDateEdit(self.MergePDF, 600, 260)
        # self.DATE_3 = self.createDateEdit(self.MergePDF, 600, 300)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("Accuration Report_3.1", "Accuration Report_3.1"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("Accuration Report_3.1", "Daily Report"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.MergePDF), _translate("Accuration Report_3.1", "Merge Daily Report PDF"))
    ...
    def process_data(self):
        try:
            ...
            # self.form_input_history["lineEdit_10e"] =lineEdit_10e
            ...
            # all_data2 = pd.DataFrame(columns=['start', 'selisih'])
            ...
            for file in log_files:
                ...
                def convert_gps_to_utc(row):
                    ...
                    target_date = gps_epoch + datetime.timedelta(days=days_since_epoch)
                    # Konversi milidetik ke detik
                    seconds = row['waktu'] / 1000.0
                    # Tambahkan detik ke tanggal target
                    target_datetime = target_date + datetime.timedelta(seconds=seconds)
                    # Konversi ke UTC+7
                    utc_plus_7_time = target_datetime + datetime.timedelta(hours=8)
                ...
                duration_datetime = datetime.datetime(1, 1, 1) + duration
            ...
            tanggal1 = all_data2['tanggal'].iloc[0]
            ...
            for file_name in sorted(os.listdir(wp)):
                if file_name.endswith('.csv'):
                    ...
                    # Definisikan mapping warna untuk setiap status Accurate': 'limegreen', 'Missed': 'red', 'Not Accurate': 'dodgerblue'
                    ...
                    colors = [status_color_map[status] for status in data_counts.index]

                    # Visualisasi pie chart
                    explode = [0.02] * len(data_counts)
                    plt.pie(data_counts.values, labels=data_counts.index, autopct='%0.01f%%', 
                    ...
                    colors = {'Accurate': 'limegreen', 'Missed': 'red', 'Not Accurate': 'dodgerblue', 'Not Sprayed' : 'brown'}
                    ...
                    df1['Percentage'] = (df1['Number of Trees'] / df1['Number of Trees'].sum() * 100).round(2)
                    total = pd.DataFrame([['Total', df1['Number of Trees'].sum().round(0), df1['Percentage'].sum().round(0)]], columns=['Status', 'Number of Trees', 'Percentage'])
                    df1 = pd.concat([df1, total], ignore_index=True)
                    
                    a = [hasil_pengukuran_terdekat['Status'].count()] 
                    # totall = [df1['Status'].count()]
                    temp_df = pd.DataFrame({"nama": base1, "total":a})
                    
                    # temp_df = pd.DataFrame({"nama": base1, "total": df1['Number of Trees']})
            ...
            df_merged.to_csv(os.path.join(junk, 'GABUNG.csv'), index=False)        
            tanggal = df_merged['tanggal'].iloc[0]
            print(tanggal)
            ...
            sheet_df.column_dimensions['C'].width = 4
            sheet_df.column_dimensions['D'].width = 23
            sheet_df.column_dimensions['E'].width = 4
            sheet_df.column_dimensions['F'].width = 23
            sheet_df.column_dimensions['G'].width = 4
            sheet_df.column_dimensions['H'].width = 23
            sheet_df.row_dimensions[2].height = 25
            sheet_df.row_dimensions[32].height = 30
            sheet_df.row_dimensions[36].height = 60
            sheet_df.row_dimensions[37].height = 60
            sheet_df.row_dimensions[38].height = 60
            sheet_df.row_dimensions[39].height = 60
            ...
            sheet_df.row_dimensions[52].height = 60
            sheet_df.row_dimensions[53].height = 60
            sheet_df.row_dimensions[54].height = 60
            sheet_df.row_dimensions[55].height = 60
            ...
            merge_ranges = [
                ('C5:D5', 'B5', 'Arrival Time to Location'),
                ('C6:D6', 'B6', 'Height From Crop (m)'),
                ('C7:D7', 'B7', 'Flying Speed (m/s)'),
                ('C8:D8', 'B8', 'Swath (m)'),
                ('C12:D12', 'B12', 'Drone Type'),
                ('C13:D13', 'B13', 'Herbicide Ratio (%)'),

                ('C19:D19', 'B19', 'Chemical Misxture'),
                ('C24:D24', 'B24', 'Driver'),
                ('C25:D25', 'B25', 'Car Plate No'),

                ('G5:H5', 'F5', 'Herbicide Time Ready'),
                ('G6:H6', 'F6', 'PIC'),
                ('G7:H7', 'F7', 'Pilot'),
                ('G8:H8', 'F8', 'Co-Pilot/Coordinator'),
                ('G9:H9', 'F9', 'GCS'),
                ('G10:H10', 'F10', 'Support'),
                ('G12:H12', 'F12', 'Nozzle Type (Color)'),
                ('G13:H13', 'F13', 'District Name'),
                ('G14:H14', 'F14', 'District PIC'),
                ('G18:H18', 'F18', 'Plot Number1'),
                ('G19:H19', 'F19', 'Plot Number2'),
                ('G20:H20', 'F20', 'Plot Number3'),
                ('G21:H21', 'F21', 'Plot Number4'),
                ('G22:H22', 'F22', 'Plot Number5'),
                # ('G23:H23', 'F23', 'Working Area3 (Ha)'),
                ('G24:H24', 'F24', 'Countur Degree'),
                ('G25:H25', 'F25', 'Date'),
                ('C27:H27', 'C27', f'Officer: {self.lineEdit_10z3.text()}'),
                ('C28:H28', 'C28', 'Mission:'),
                ('C29:H30', 'C29', ''),
                ('C31:H31', 'C31', 'Purpose:'),
                ('C32:H33', 'C32', ''),
                ...
                ('C55:F55', 'C55', ''),
                ('G55:H55', 'G55', ''),
                ('G15:H15', 'F15', 'Spraying'),
                ('C14:D14', 'B14', 'Chemical Type') 
            ]
            ...
            data = [
                # ('B14', 'Chemical Type'),
                ('B27', 'Note/Info'),
                # ('D14', self.comboBox_10g.currentText()),
                # ('D15', 'Insecticide'),
                # ('D16', 'Fertilizer'),
                # ('D17', 'Fungicide'),
                # ('D18', 'Larvacide'),
                # ('F15', 'Spraying'),
                # ('H15', self.comboBox_10t.currentText()),
                # ('H16', 'Spot Reservice'),
                # ('H17', self.comboBox_10t.currentText()),
                ('C35', 'No'), ('D35', 'Situation'), ('G35', 'Solution'),
                # ('C36', '1'),
                # ('C36', '2'),
                # ('C36', '3'),
                # ('C36', '4'),
            ...
            sheet_df['D35'].alignment = alignment
            sheet_df['G35'].alignment = alignment
            sheet_df['C36'].alignment = alignment
            sheet_df['C37'].alignment = alignment
            sheet_df['C38'].alignment = alignment
            sheet_df['C38'].alignment = alignment
            sheet_df['C39'].alignment = alignment
            sheet_df['G40'].alignment = alignment
            sheet_df['G41'].alignment = alignment
            sheet_df['G42'].alignment = alignment
            sheet_df.merge_cells('D35:F35')
            sheet_df.merge_cells('G35:H35')

            # cell_chemicaltype = sheet_df['C15']
            # cell_sprayingtype = sheet_df['G17']
            # checklist_symbol = '✔'  # or '✓'_
            # cell_chemicaltype.value = checklist_symbol
            # cell_sprayingtype.value = checklist_symbol
            ...
            sheet_log['I1'] = "Memo"
            sheet_log['I1'].font = Font(name='Arial', size=11)

            sheet_log['I5'] = " ↑ You can edit this row above"
            sheet_log['I5'].font = Font(name='Arial', size=11)
            ...
            sheet_flight_statistic['A2'].font = Font(name='Arial Narrow', size=16, bold=True)
            ...
            data_df_atas = [
                ...
                ('C19', self.lineEdit_10h.text()),
                ('C24', self.lineEdit_10i.text()),
                ('C25', self.lineEdit_10j.text()),
                ('G5' , self.lineEdit_10k.text()),
                ('G6' , self.lineEdit_10l.text()),
                ('G7' , self.lineEdit_10m.text()),
                ('G8' , self.lineEdit_10n.text()),
                ('G9' , self.lineEdit_10o.text()),
                ('G10', self.lineEdit_10p.text()),
                ('G12', self.lineEdit_10q.text()),
                ('G13', self.lineEdit_10r.text()),
                ('G14', self.lineEdit_10s.text()),
                ('G18', blok1),
                ('G19', blok2),
                ('G20', blok3),
                ('G21', blok4),
                ('G22', blok5),
                # ('G23', self.lineEdit_10z.text()),
                ('G15', self.comboBox_10t.currentText()),
                ('C14', self.comboBox_10g.currentText()),
                ('G24', self.comboBox_10z1.currentText()),
                ('G25', df_merged['tanggal'].head().iloc[0]),
                ('C29', self.lineEdit_10z4.text()),                 #Isinya Mision
                ('C32', self.textEdit_10z5.toPlainText()),          #Isinya Purpose
                
                ('D36', self.textEdit_situation_1.toPlainText()),
                ('D37', self.textEdit_situation_2.toPlainText()),
                ('D38', self.textEdit_situation_3.toPlainText()),
                ('D39', self.textEdit_situation_4.toPlainText()),
                ('G36', self.textEdit_solution_1.toPlainText()),
                ('G37', self.textEdit_solution_2.toPlainText()),
                ('G38', self.textEdit_solution_3.toPlainText()),
                ('G39', self.textEdit_solution_4.toPlainText()),
                ('C44', self.textEdit_worktime_1a.toPlainText()),
                ('G44', self.textEdit_worktime_1b.toPlainText()),
                ('C45', self.textEdit_worktime_2a.toPlainText()),
                ('G45', self.textEdit_worktime_2b.toPlainText()),
                ('C46', self.textEdit_worktime_3a.toPlainText()),
                ('G46', self.textEdit_worktime_3b.toPlainText()),
                ('C47', self.textEdit_worktime_4a.toPlainText()),
                ('G47', self.textEdit_worktime_4b.toPlainText()),
                ('C48', self.textEdit_worktime_5a.toPlainText()),
                ('G48', self.textEdit_worktime_5b.toPlainText()),
                ('C49', self.textEdit_worktime_6a.toPlainText()),
                ('G49', self.textEdit_worktime_6b.toPlainText()),
                ('C50', self.textEdit_worktime_7a.toPlainText()),
                ('G50', self.textEdit_worktime_7b.toPlainText())]
            ...
            awal = pd.read_csv(os.path.join(junk, 'GABUNG.csv'))
            ...
            # Tulis hasil total ke baris 32
            sheet_log1['E132'] = spray_trees_total
            sheet_log1['F132'] = spray_area_ha_total
            sheet_log1['G132'] = spray_dose_total
            ...
            sheet_flight_statistic1['I12'].value = sheet_log1['F132'].value
            sheet_flight_statistic1['I13'].value = sheet_log1['D132'].value
            sheet_flight_statistic1['I14'].value = sheet_log1['G132'].value
        ...
        try :
            ...
            class PDF(FPDF):
                ...
                def add_images(self, png_output_report_status, pie_chart, png_output_statistic_date):
                    ...
                    self.image(png_output_statistic_date, x=100, y=175, w=95)
            ...
            # Definisikan mapping warna untuk setiap status
            status_color_map = {
                'Accurate': 'limegreen',
                'Not Accurate': 'dodgerblue',
                'Missed': 'red',
            ...
            explode = [0.02] * len (data_counts)
            plt.pie(data_counts.values, labels=data_counts.index, autopct='%0.01f%%', explode=explode, shadow={'ox': -0.01, 'edgecolor': 'none', 'shade': 0.9}, startangle=90, colors= colors)
            # plt.title('Summary Status', fontweight='bold')
            ...
            df2 = pd.DataFrame()
            df2['Name'] = statistik_penyemprotan.index
            df2['Number of Trees'] = statistik_penyemprotan.values
            df2['Percentage'] = (df2['Number of Trees'] / df2['Number of Trees'].sum() * 100).round(2)
            total = pd.DataFrame([['Total', df2['Number of Trees'].sum().round(0), df2['Percentage'].sum().round(0)]], columns=['Name', 'Number of Trees', 'Percentage'])
            df2 = pd.concat([df2, total], ignore_index=True)
            print(df2)
