...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("Accuration Report_3.3", "Accuration Report_3.3"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("Accuration Report_3.3", "Daily Report"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.MergePDF), _translate("Accuration Report_3.3", "Merge Daily Report PDF"))
    ...
    def process_data(self):
        try:
            ...
            wp_files = [file for file in os.listdir(self.data_waypoint) if file.endswith(".waypoints")]
            if not wp_files:
            ...
            for file in log_files:
                ...
                def convert_gps_to_utc(row):
                    ...
                    # Konversi ke UTC+7
                    utc_plus_7_time = target_datetime + timedelta(hours=8)                
            ...
            formatted_datee = df_merged['tanggal'].iloc[0].strftime('%Y/%m/%d')
...
# ------------------------------------------------------------------------ end of excel ----------------------------------------------------------
    ...
    def merge_data(self):
        try :
            ...
            status_priority = {"Accurate": 1, "Not Accurate": 2, "Missed": 3, "Not Sprayed": 4}
